...
//jobs init
WorkScheduler *getDataFromWebsiteScheduler;
WorkScheduler *getTouchAndSendToWebsiteScheduler;
...
void setup()
{
  ...
  getTouchAndSendToWebsiteScheduler = new WorkScheduler(delay_1x/10, sendDataToWebsite);
  getDataFromWebsiteScheduler = new WorkScheduler(delay_3x, getDataFromWebsite);
...
void loop()
{
  ...
  getTouchAndSendToWebsiteScheduler->update();
  getDataFromWebsiteScheduler->update();
